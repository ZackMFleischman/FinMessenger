...
try:
    ...
    parser.add_argument('-t', dest='title', help='The optional title of the message')
...
def CreateMessageWithAttachment(sender, to, subject, message_text, file_dir,
  ...
  return {'raw': base64.b64encode(bytes(message.as_string()))}
...
def SendFinAMessage():
    ...
    args:
        ...
        -t [title]: (Optional) This will be the title and the 1st arg is the body.
    """
    ...
    msg = CreateMessage("zfleischman@gmail.com", "zfleischman@in.getfin.com", subject, body)
    #msg = CreateMessage("zfleischman@gmail.com", "zfleischman@gmail.com", subject, body)
